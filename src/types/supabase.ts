...
export type Database = {
  public: {
    Tables: {
      profiles: { // Updated profiles table definition V3.2 - Added composio_api_key
        Row: {
          ...
          xp: number | null
          badges: string[] | null
          composio_api_key: string | null // Added Composio API key field
        }
        Insert: {
          id: string // UUID, references auth.users.id
          updated_at?: string | null
    ...
    Functions: {
      ...
      get_user_profile: {
        ...
        Returns: { // Update return type to match updated profiles.Row V3.2 - Added composio_api_key
          id: string
          updated_at: string | null
          username: string | null
          full_name: string | null
